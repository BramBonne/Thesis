...
%TODO: zeggen waar plugin available is
...
% TODO: Nvertheless, useful because: XSS groot probleem (cite), maar toch nog lang niet opgelost (zie countermeasures)
...
% HTTPONLY: Good point about HTTPOnly not preventing writes. 

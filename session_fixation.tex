...
cooking would have to consist of prohibiting subdomains from
...
from URLs. Unfortunately, this would break all websites that perform their session management exclusively via URL rewriting.

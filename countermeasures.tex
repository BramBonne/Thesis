...
\section{Stand-alone server countermeasures}\label{standalone-server}
...
% TODO: conclusie en comparison-tabel

\begin{table}[htb]
	\centering
	\begin{tabular}{r|cccc}
		& Server-side & Client-side & Session hijacking protection & Session fixation protection\\
		& on auth & cookie-based SIDs & SSL session cookies\\
		\hline
		Tomcat & since version 6 & implementable & default\\
		Alfresco & no & implementable & default\\

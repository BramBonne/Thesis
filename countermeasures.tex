...
SessionSafe is a combination of three solutions to session hijacking (and cross site request forgery) proposed by Johns et al. in 2006 \cite{Johns2006}. We describe the first one in this section, and the other two in the next sections.
...
\subsubsection{Subdomain switching (SessionSafe)}

\subsubsection{SessionShield}

...
In this chapter, some general countermeasures to the session hijacking and session fixation attacks are discussed. We also briefly describe some solutions to cross site scripting attacks, because of their importance in session attacks. We do not consider solutions to cross site request forgery here, since these would lead us too far. For more information about cross site request countermeasures, the reader is directed to \cite{DeRyck2010,Zeller2008,Johns2006,Mao2009}.

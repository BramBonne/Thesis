...
\begin{figure}[ht]
	...
	\subfloat[persistent]{
		...
		\includegraphics[width=.45\textwidth]{img/sessionsafe-deferred-get.png}
		\caption{Requesting a page}
	}
	\subfloat[reflected]{
		\label{fig:sessionsafe-deferred-set}
		\includegraphics[width=0.45\textwidth]{img/sessionsafe-deferred-set.png}
		\caption{Setting the cookie}
	}
...
% How to know when authentication changed
